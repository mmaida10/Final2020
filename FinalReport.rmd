...
The study drug is `r Girlseff`% effective on drug users, which is based on a confidence interval of `r Girlsefflowereff` to `r Girlseffuppereff`. Based on these factors, I would recommend gals to receive the Covid91 study drug.  
